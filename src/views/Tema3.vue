  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center
      .col-lg-10.col-md-12
        ...
        .row.justify-content-center.fnd(data-aos="flip-up")
          .col-lg-8
          ...
          .col-lg-4.col-md-8.align-content-center
            img.my-3(src='@/assets/curso/temas/tema3/img8.svg', alt='Imagen decorativa')
        
        .row.justify-content-center
          .col-lg-3.col-md-5(data-aos="fade-right")
          ...
          .col-lg-9(data-aos="fade-left")
            ...
            .row.pe-lg-3.justify-content-center.align-items-center.my-2
              ...
              .col
                p.my-3 Los principales componentes de los forrajes son producto de la energía solar que por medio de la fotosíntesis es transformada en energía química.
                p Los forrajes están constituidos fundamentalmente por carbohidratos, proteínas, grasas, minerales (macroelementos y microelementos) y vitaminas.
      ...
      .col-lg-10.col-md-12
        ...
        .row.justify-content-center.align-items-center.mb-3.p-4(data-aos="zoom-in")
          .col-lg-3.col-md-5.my-3
            figure
              img.my-3(src="@/assets/curso/temas/tema3/img11.png")
          .col-lg-9
            SlyderF.custom(columnas="col-lg-6 col-md-12")
              ...
              .tarjeta.tarjeta--slyder.p-4.fnd-4
                ...
                .row.justify-content-center
        .row.justify-content-center
          .col-xl-6.col-lg-6.col-md-7.mb-4.mb-xl-0.text-center
    ...
    .row.justify-content-center.mb-3.mt-4.fondo-imagen3.p-4
      .tarjeta.tarjeta--blanca.p-4(data-aos="fade-up")
        SlyderA(tipo="b")
          ...
          .row.px-3.pt-3
            .col-lg-6.mb-4.mb-md-0.align-content-center
              p <strong>Silíceo:</strong> es absorbido por las raíces de las plantas, en las gramíneas se acumula más que en leguminosas, buena parte de este elemento se almacena en la pared celular de la planta, lo cual dificulta la digestibilidad por parte del animal.<br><strong>Fuente: Evangelista (2011).</strong>
            .col-lg-6
              figure
    ...
    .row.justify-content-center
      .col-lg-10
        ...
        TabsC.color-primario
          .py-3.py-md-4.p-3(style="background: #F6F0EA")(titulo="Bancos forrajeros")
            .row.justify-content-center
              ...
              .col-md-5.col-lg-3.align-content-center
                figure
                  img.my-3(src='@/assets/curso/temas/tema3/img21.png', alt='Texto que describa la imagen')
          
          .py-3.py-md-4.p-3(style="background: #F6F0EA")(titulo="Forraje de flujo")
            .row.justify-content-center
