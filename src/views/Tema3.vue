      ...
      .col-lg-12
        .row.justify-content-center
          .col-lg-10.col-md-12
            ...
            .row.justify-content-center
              .col-lg-3.col-md-5(data-aos="fade-right").align-content-center.order-lg-1.order-md-2
                img(src='@/assets/curso/temas/tema3/img9.png', alt='Imagen decorativa')(style="min-height: 400px")
              .col-lg-9.order-lg-2.order-md-1(data-aos="fade-left")
        ...
        .row.justify-content-center
          .col-xl-6.col-lg-6.col-md-6.mb-4.mb-xl-0.text-center
